...
function carrinhoVazio(){
    ...
    if (items === null) {
        ...
        <div class="noProduct">
            ...
            <div class="small-subtitle">Dê uma olhada nos nossos produtos<div>
            <a href="../Produtos/index.html">Ver produtos</a>
...
function mensagem(){
    ...
    var mensagemWhats = 'https://api.whatsapp.com/send?l=pt_BR&phone=5521969483478&text=Boa%20noite%20pessoal,%20gostaria%20de%20pedir:';
